...
interface CaseDoc {
   ...
   * באיזה שלב העניין נמצא, אילו מועדים הפונה עצמו ציין, ואיזה תיעוד
   * קיים — והשם התיישר אחריו.
   */
  caseContext?: string;
  /**
   * @deprecated השם הישן. מסמכים שנוצרו לפני 10/8/2026 נושאים אותו,
   * והקריאה נופלת אליו כדי שתיקים קיימים לא יאבדו את הרקע שלהם.
   * לא נכתב יותר; אפשר להסיר אחרי מיגרציה של המסמכים הישנים.
   */
  legalBasis?: string;
