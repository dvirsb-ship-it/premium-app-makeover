...
export const strings = {
  ...
  privacyContact: { he: "לשאלות פרטיות: contact@justask.co.il", en: "Privacy inquiries: contact@justask.co.il" },
  ...
  helpEmailDirect: { he: "או במייל: contact@justask.co.il", en: "Or by email: contact@justask.co.il" },
  ...
  /* פיניש גיוס עורכי דין (26/8/2026) */
  onbAlreadyTitle: { he: "הבקשה שלך כבר אצלנו", en: "Your application is already with us" },
  onbAlreadyBody: { he: "ההגשה התקבלה ונמצאת בבדיקה — אין צורך למלא שוב. נעדכן אותך ברגע שההחלטה תתקבל.", en: "Your submission was received and is under review — no need to fill it in again. We'll update you the moment there's a decision." },
  onbAlreadyCta: { he: "למסך הפניות", en: "To your referrals" },
  onbAlreadyRefill: { he: "צריך לתקן משהו? מילוי מחדש", en: "Need to fix something? Fill in again" },
  foundingChip: { he: "תקופת מייסדים — ללא תשלום עד {date}", en: "Founding period — free until {date}" },
  proFoundingLine: { he: "מצטרפי תקופת ההשקה: חצי השנה הראשונה ללא תשלום, נספרת מיום האישור.", en: "Launch-period joiners: your first six months are free, counted from approval day." },
  refsLoadError: { he: "טעינת הפניות נכשלה. בדקו את החיבור ונסו לרענן — הפניות שלכם שמורות.", en: "Loading referrals failed. Check your connection and refresh — your referrals are safe." },
  notifVerReceivedTitle: { he: "ההגשה התקבלה", en: "Submission received" },
  notifVerReceivedBody: { he: "הפרופיל שלך בבדיקה — נעדכן ברגע שההחלטה תתקבל.", en: "Your profile is under review — we'll update you the moment there's a decision." },
  ...
  /* ── "אצל מי הכדור" לעורך הדין (25/9/2026) — מה השלב, מה הפעולה, וכמה זמן נשאר ── */
  refBallYouNames: { he: "הכדור אצלך: בדיקת ניגוד עניינים", en: "Your move: conflict-of-interest check" },
  refBallClientShare: { he: "הכדור אצל הפונה: ממתין שישתף את הסיכום", en: "The client's move: waiting for them to share the summary" },
  refBallYouOffer: { he: "הכדור אצלך: הגשת הצעה — או \"אינני זמין\"", en: "Your move: submit an offer — or decline" },
  refBallClientOffer: { he: "הכדור אצל הפונה: ההצעה שלך אצלו", en: "The client's move: your offer is with them" },
  refTimeLeftH: { he: "נותרו ~{h} שעות", en: "~{h} hours left" },
  refTimeLeftSoon: { he: "פחות משעה", en: "under an hour" },
  refExpiredNames: { he: "חלון בדיקת הניגוד (48 שעות) חלף — הפנייה נסגרה והפונה עודכן", en: "The 48-hour conflict-check window passed — the referral closed and the client was notified" },
  refExpiredOffer: { he: "חלון ההצעה (48 שעות) חלף — הפנייה נסגרה והפונה עודכן", en: "The 48-hour offer window passed — the referral closed and the client was notified" },
  notifRefExpiredNamesTitle: { he: "חלון בדיקת הניגוד חלף", en: "Conflict-check window passed" },
  notifRefExpiredNamesBody: { he: "פנייה אליך פקעה אחרי 48 שעות ללא מענה. המקום חזר לפונה.", en: "A referral to you expired after 48 hours with no reply. The slot went back to the client." },
  notifRefExpiredOfferTitle: { he: "חלון ההצעה חלף", en: "Offer window passed" },
  notifRefExpiredOfferBody: { he: "קראת את הסיכום ולא הוגשה הצעה בתוך 48 שעות — הפנייה נסגרה.", en: "The summary was read but no offer was submitted within 48 hours — the referral closed." },
  lcConnectedChip: { he: "נוצר חיבור — הלקוח בחר בך", en: "Connected — the client chose you" },
  lcNoContactWarn: { he: "הלקוח דיווח שעדיין לא נוצר קשר — כדאי להתקשר עוד היום.", en: "The client reported no contact yet — best to call today." },
  lcJourneyHeader: { he: "מסלול הפנייה", en: "The referral's journey" },
  lcJrReceived: { he: "הפנייה התקבלה אצלך", en: "Referral received" },
  lcJrCleared: { he: "אישרת: אין ניגוד עניינים", en: "You confirmed: no conflict" },
  lcJrShared: { he: "הפונה שיתף את הסיכום", en: "The client shared the summary" },
  lcJrOffered: { he: "הגשת הצעת שכר טרחה", en: "You submitted a fee offer" },
  lcJrConnected: { he: "הלקוח בחר בך — נוצר חיבור", en: "The client chose you — connected" },
  lcJrContact: { he: "אישרת שנוצר קשר", en: "You confirmed contact" },
  ...
  refYourOffer: { he: "ההצעה שהגשת", en: "Your submitted offer" },
  ...
  refDeclinedByYou: { he: "השבת שאינך זמין לפנייה זו — הפונה עודכן בנוסח ניטרלי", en: "You replied that you're not available — the client was told in neutral wording" },
  ...
  /* ── יומן התיק — מנהל התיק האישי (25/9/2026) ── */
  evContactConfirmed: { he: "עו״ד {name} אישר שנוצר קשר", en: "Adv. {name} confirmed you're in touch" },
  evContactConfirmedBody: { he: "מכאן ממשיכים יחד — נעדכן כאן על כל צעד בתיק.", en: "From here you continue together — every step will show up here." },
  evContactReminded: { he: "שלחנו תזכורת לעו״ד {name}", en: "We sent Adv. {name} a reminder" },
  evContactRemindedBody: { he: "טרם אושר שנוצר קשר — ביקשנו ממנו להרים טלפון. עדיין שקט? ספרו לנו מתוך התיק.", en: "Contact wasn't confirmed yet — we asked them to call. Still quiet? Tell us from the case screen." },
  evNoContactReport: { he: "קיבלנו את הדיווח שלך", en: "We got your report" },
  evNoContactReportBody: { he: "אנחנו בודקים את זה מול עורך הדין. לא תישארו לבד עם זה.", en: "We're checking with the lawyer. You won't be left alone with this." },
  evMilestone: { he: "עו״ד {name} עדכן את התיק", en: "Adv. {name} updated the case" },
  lcContactBtn: { he: "יצרתי קשר עם הלקוח", en: "I contacted the client" },
  lcContactDone: { he: "אישרת שנוצר קשר ✓", en: "You confirmed contact ✓" },
  lcContactHint: { he: "אישור בלחיצה אחת — הלקוח רואה שהתיק בידיים טובות.", en: "One tap — the client sees the case is in good hands." },
  caseNoContactQ: { he: "עורך הדין עדיין לא יצר קשר? ספרו לנו", en: "Lawyer hasn't been in touch? Tell us" },
  caseNoContactSent: { he: "קיבלנו. אנחנו על זה — ולא תישארו לבד עם זה.", en: "Got it. We're on it — you won't be left alone with this." },

  evCaseCreated: { he: "פתחת את התיק", en: "You opened the case" },
  evCaseCreatedBody: { he: "סיפרת מה קרה, והמערכת סידרה סיכום עובדתי.", en: "You told us what happened and we organized a factual summary." },
  evSummaryReady: { he: "הסיכום שלך מוכן", en: "Your summary is ready" },
  evSummaryReadyBody: { he: "עברו עליו, תקנו מה שצריך ואשרו — משם בוחרים עורך דין.", en: "Review it, fix what's needed and approve — then pick a lawyer." },
  evSummaryApproved: { he: "אישרת את הסיכום", en: "You approved the summary" },
  evSummaryApprovedBody: { he: "מכאן אפשר לפנות לעורכי דין מהאינדקס — עד שלושה במקביל.", en: "From here you can contact lawyers from the index — up to three at once." },
  evReferralSent: { he: "שלחנו את שמות הצדדים לעו״ד {name}", en: "We sent the party names to Adv. {name}" },
  evReferralSentBody: { he: "בשלב הזה נחשפים שמות בלבד, לבדיקת ניגוד עניינים. רוב עורכי הדין עונים בתוך יום.", en: "Only names are shared at this stage, for a conflict check. Most lawyers reply within a day." },
  evReferralCleared: { he: "עו״ד {name} אישר: אין ניגוד עניינים", en: "Adv. {name} confirmed: no conflict of interest" },
  evReferralClearedBody: { he: "תורך — אישור שיתוף הסיכום.", en: "Your turn — approve sharing the summary." },
  evSummaryShared: { he: "שיתפת את הסיכום עם עו״ד {name}", en: "You shared the summary with Adv. {name}" },
  evSummarySharedBody: { he: "הוא קורא את הסיכום העובדתי בלבד. נעדכן כשתגיע הצעה.", en: "They read the factual summary only. We'll update you when an offer arrives." },
  evSummaryAutoShared: { he: "הסיכום שותף עם עו״ד {name}", en: "The summary was shared with Adv. {name}" },
  evSummaryAutoSharedBody: { he: "אין ניגוד עניינים, ושיתפנו אוטומטית לפי אישורך מראש. נעדכן כשתגיע הצעה.", en: "No conflict found, and we shared automatically per your prior consent. We'll update you when an offer arrives." },
  evReferralDeclined: { he: "עו״ד {name} אינו זמין לפנייה", en: "Adv. {name} is unavailable for this request" },
  evReferralDeclinedBody: { he: "זה לא אומר דבר על המקרה. אפשר לבחור עורך דין אחר מהאינדקס.", en: "This says nothing about your case. You can pick another lawyer from the index." },
  evOfferReceived: { he: "עו״ד {name} הגיש הצעת שכר טרחה", en: "Adv. {name} submitted a fee offer" },
  evOfferReceivedBody: { he: "אפשר להשוות בין ההצעות זו לצד זו ולבחור.", en: "You can compare offers side by side and choose." },
  evConnected: { he: "נוצר חיבור עם עו״ד {name}", en: "You're connected with Adv. {name}" },
  evConnectedBody: { he: "פרטי הקשר נחשפו לשני הצדדים. מכאן ההסכם נכרת ישירות ביניכם.", en: "Contact details are now open to both sides. From here the agreement is directly between you." },
  evCaseWithdrawn: { he: "ביטלת את הפנייה", en: "You withdrew the case" },
  evCaseWithdrawnBody: { he: "כל הפניות שהיו פתוחות נסגרו אצל עורכי הדין בנוסח מכובד.", en: "All open referrals were closed for the lawyers, respectfully." },
  evReferralExpired: { he: "הפנייה לעו״ד {name} הסתיימה ללא מענה", en: "The referral to Adv. {name} ended without a reply" },
  evReferralExpiredBody: { he: "המקום התפנה — אפשר לבחור עורך דין אחר מהאינדקס.", en: "The slot is free — you can pick another lawyer from the index." },
  evOfferExpired: { he: "עו״ד {name} לא הגיש הצעה", en: "Adv. {name} didn't submit an offer" },
  evOfferExpiredBody: { he: "חלון ההצעה הסתיים. אפשר לבחור עורך דין אחר מהאינדקס.", en: "The offer window closed. You can pick another lawyer from the index." },
  evLawyerReminded: { he: "שלחנו תזכורת עדינה לעו״ד {name}", en: "We sent Adv. {name} a gentle reminder" },
  evLawyerRemindedBody: { he: "טרם התקבל מענה — טיפלנו בזה. לא נדרשת פעולה ממך.", en: "No reply yet — we handled it. Nothing needed from you." },
  evShareNudge: { he: "תזכורת: הכדור אצלך", en: "Reminder: the ball is with you" },
  evShareNudgeBody: { he: "עו״ד {name} ממתין לאישור שיתוף הסיכום.", en: "Adv. {name} is waiting for you to approve sharing the summary." },
  evOfferNudge: { he: "תזכורת: יש הצעה שממתינה לך", en: "Reminder: an offer is waiting for you" },
  evOfferNudgeBody: { he: "ההצעה של עו״ד {name} עדיין פתוחה. אין לחץ — היא לא נעלמת.", en: "Adv. {name}'s offer is still open. No rush — it isn't going anywhere." },
  jrTitle: { he: "יומן התיק", en: "Case journal" },
  jrNow: { he: "מה עכשיו", en: "What's now" },
  jrBallYou: { he: "הכדור אצלך", en: "The ball is with you" },
  jrBallLawyers: { he: "הכדור אצל עורכי הדין", en: "The ball is with the lawyers" },
  jrBallSystem: { he: "אנחנו על זה", en: "We're on it" },
  jrBallDone: { he: "נוצר חיבור", en: "You're connected" },
  jrNowValidating: { he: "הסיכום נכתב עכשיו — בדרך כלל פחות מדקה.", en: "Your summary is being written — usually under a minute." },
  jrNowSummaryReady: { he: "הסיכום מוכן. עברו עליו ואשרו — משם בוחרים עורך דין.", en: "The summary is ready. Review and approve — then pick a lawyer." },
  jrToday: { he: "היום", en: "Today" },
  jrYesterday: { he: "אתמול", en: "Yesterday" },
  jrUpcoming: { he: "בהמשך", en: "Up next" },
  jrPendingCheck: { he: "כשעורך הדין ישיב — נעדכן אותך מיד", en: "When the lawyer replies — we'll update you right away" },
  jrPendingCheckBody: { he: "אין מה לעשות בינתיים. רוב התשובות מגיעות בתוך יום.", en: "Nothing to do meanwhile. Most replies arrive within a day." },
  jrPendingOffer: { he: "כשתגיע הצעת שכר טרחה — היא תופיע כאן", en: "When a fee offer arrives — it will appear here" },
  jrPendingOfferBody: { he: "תקבלו עדכון, ותוכלו להשוות בין ההצעות זו לצד זו.", en: "You'll get an update and can compare offers side by side." },
  jrPendingChoose: { he: "אחרי שתבחרו — ניצור את החיבור", en: "Once you choose — we'll make the connection" },
  jrPendingChooseBody: { he: "הבחירה חושפת את פרטי הקשר לשני הצדדים וסוגרת את שאר הפניות.", en: "Choosing opens contact details to both sides and closes the other referrals." },
  ...
  caseRefChoose: { he: "בחר בעורך דין זה", en: "Choose this lawyer" },
  caseRefChooseHint: { he: "הבחירה חושפת את פרטי הקשר לשני הצדדים וסוגרת את שאר הפניות בתיק.", en: "Choosing reveals contact details to both sides and closes the case's other requests." },
  ...
  a11ySection4Body: { he: "אם נתקלת בקושי נגישות באפליקציה, נשמח לדעת ולתקן: contact@justask.co.il. אנא ציינו את הדף, הפעולה והקושי — נחזור אליכם בהקדם.", en: "If you hit an accessibility issue, email contact@justask.co.il with the page, the action and the difficulty — we will get back to you promptly." },
  a11ySection5Title: { he: "רכז הנגישות ודפדפנים שנבדקו", en: "Accessibility coordinator and browsers tested" },
  a11ySection5Body: { he: "רכז הנגישות: דביר, מפעיל השירות — contact@justask.co.il. אפשר לפנות בכל שאלה, בקשה או תלונה בנושא נגישות, ונחזור אליכם. האפליקציה נבדקה בדפדפני Chrome ו-Safari בגרסאותיהם העדכניות, במחשב ובמכשיר נייד.", en: "Accessibility coordinator: Dvir, the service operator — contact@justask.co.il. You are welcome to raise any accessibility question, request or complaint, and we will get back to you. The app was tested on current versions of Chrome and Safari, on desktop and on mobile." },
  ...
  suspendLawyerHint: { he: "מסיר מהאינדקס וחוסם קבלת פניות חדשות. תיקים פעילים ממשיכים — ניתוק לקוח באמצע תיק פוגע בו, לא מגן עליו.", en: "Removes from the index and blocks new referrals. Active cases continue — cutting a client mid-case harms them, not protects them." },
  ...
  lpStep2: {
    he: "הפנייה מגיעה אליך עם שמות הצדדים בלבד — לבדיקת ניגוד עניינים. אישרת שאין ניגוד? הסיכום נפתח ואתה מגיש הצעה.",
    en: "The referral reaches you with party names only — for a conflict check. No conflict? The summary opens and you submit a proposal.",
  },
  lpStep3: {
  ...
  lpSpin2Body: { he: "סיכום עובדתי מאורגן — הצדדים, האירוע והתיעוד המוצהר — לפני שאתה מקדיש דקה אחת לתיק.", en: "An organised factual summary — parties, incident and declared documentation — before you spend a single minute." },
  lpSpin3Title: { he: "ההצעה שלך, לפני הבחירה", en: "Your proposal, before the choice" },
  lpSpin3Body: { he: "אתה מגיש הצעת שכר טרחה. הפונה בוחר — ורק אז נחשפים פרטיו.", en: "You submit a fee proposal. The person chooses — and only then are their details revealed." },
  ...
  /* לוח המסלול המלא (26/8/2026) — הסבר מושקע לכל שלב */
  journeyDetail1: { he: "בשיחה קצרה אוספים את העובדות: מה קרה, מתי, מי מעורב ואיזה תיעוד קיים בידיכם. מהשיחה נבנה סיכום עובדתי מסודר — ואתם קוראים, עורכים ומאשרים כל מילה לפני שהוא ממשיך הלאה.", en: "A short chat gathers the facts: what happened, when, who's involved and what documentation you hold. It becomes an organized factual summary — you read, edit and approve every word before it goes anywhere." },
  journeyDetail2: { he: "בוחרים לבד מהאינדקס — לפי תחום, עיר ושפה. אין דירוג ואין קידום ממומן: כולם מוצגים באותו סדר אחיד. אפשר לפנות עד שלושה עורכי דין במקביל, ולכל פנייה 48 שעות למענה.", en: "You choose from the index yourself — by field, city and language. No rankings, no paid placement: everyone appears in the same uniform order. Contact up to three lawyers at once; each request stays open 48 hours." },
  journeyDetail3: { he: "עורך הדין רואה תחילה את שמות הצדדים בלבד, כדי לוודא שאין ניגוד עניינים. רק אחרי שאישר — הסיכום שאישרתם נחשף אליו. פרטי הקשר שלכם נשארים חסויים.", en: "The lawyer first sees the parties' names only, to check for a conflict of interest. Only after confirming does the summary you approved open to them. Your contact details stay hidden." },
  journeyDetail4: { he: "מי שקרא את הסיכום מגיש הצעת שכר טרחה מפורטת: מודל, אחוזים או סכום, מע״מ והוצאות. משווים את כל ההצעות זו לצד זו — כולל ״מה זה אומר בכסף״. איננו ממליצים ואיננו מדרגים: הבחירה כולה שלכם.", en: "A lawyer who read the summary submits a detailed fee offer: model, percentage or amount, VAT and expenses. Compare all offers side by side — including 'what it means in money'. We don't rank or recommend: the choice is entirely yours." },
  journeyDetail5: { he: "בחרתם? רק עכשיו נחשפים פרטי הקשר — לשני הצדדים — ושאר הפניות נסגרות מאליהן. ההסכם נכרת ישירות ביניכם, ותמשיכו לקבל עדכון על כל אבן דרך בטיפול.", en: "Chose? Only now are contact details revealed — to both sides — and the other requests close automatically. The agreement is made directly between you, and you'll get an update at every milestone." },
  journeyNoAction: { he: "אין פעולה שנדרשת מכם כרגע — נעדכן ברגע שיש חדש.", en: "Nothing needed from you right now — we'll update you the moment there's news." },
  ...
  /* "משיכת הפנייה" היה ז'רגון — גם דביר לא הבין אותו (26/8/2026) */
  withdrawCta: { he: "ביטול הפנייה", en: "Cancel this request" },
  withdrawHint: { he: "הביטול סוגר את הפנייה אצל כל עורכי הדין שקיבלו אותה, והם יעודכנו. הסיפור נשאר שמור אצלכם ברשימת התיקים.", en: "Cancelling closes the request with every lawyer who received it, and they'll be notified. Your story stays saved in your case list." },
  withdrawConfirmTitle: { he: "לבטל את הפנייה?", en: "Cancel this request?" },
  withdrawConfirmBody: { he: "הפנייה תיסגר אצל כל עורכי הדין שקיבלו אותה והם יעודכנו. לא יתקבלו עוד הצעות. הסיפור נשאר שמור אצלכם ברשימת התיקים.", en: "The request closes with every lawyer who received it and they'll be notified. No further offers will arrive. Your story stays saved in your case list." },
  withdrawConfirmBtn: { he: "כן, לבטל את הפנייה", en: "Yes, cancel it" },
