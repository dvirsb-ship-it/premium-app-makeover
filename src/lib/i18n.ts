...
export const strings = {
  ...
  staleCheckBody: { he: "הבדיקה המשפטית אמורה לקחת פחות מדקה, וכאן היא נתקעה. אף עורך דין לא ראה את הפנייה הזו. אפשר להסיר אותה ולשלוח מחדש — הסיפור שלכם לא הולך לאיבוד.", en: "The legal check should take under a minute, and this one stalled. No lawyer has seen this case. You can remove it and send again — your story isn't lost." },
