...
export const strings = {
  ...
  submittedStep1: { he: "הסיכום שלך מוכן ומאושר", en: "Your summary is ready and approved" },
  ...
  refStageANote: { he: "זה כל המידע בשלב הזה. תיאור המקרה ייחשף רק אם תאשר זמינות והפונה יאשר שיתוף.", en: "This is all the information at this stage. The case description is revealed only if you confirm availability and the applicant approves sharing." },
  refClear: { he: "אין ניגוד — אני זמין", en: "No conflict — I'm available" },
  refDecline: { he: "אינני זמין לפנייה זו", en: "Not available for this one" },
  refWaitClient: { he: "אישרת זמינות · ממתין לפונה לשתף את הסיכום", en: "Availability confirmed · waiting for the applicant to share" },
  ...
  caseRefCleared: { he: "אין ניגוד והוא זמין — אשר שיתוף הסיכום", en: "No conflict, available — approve sharing your summary" },
  caseRefShared: { he: "הסיכום שותף · ממתין להצעה", en: "Summary shared · awaiting an offer" },
  ...
  idxLimit: { he: "אפשר לפנות לעד שלושה עורכי דין במקביל", en: "You can approach up to three lawyers at a time" },
  ...
  homeNewShared: { he: "הסיכום שותף — ממתין להצעת שכר טרחה", en: "Summary shared — awaiting a fee proposal" },
  ...
  journeyStep1: { he: "מספרים מה קרה, מאשרים סיכום עובדתי, ובוחרים תחום. חינם, ותמיד יישאר חינם.", en: "Tell what happened, approve a factual summary, and pick a field. Free, and it stays free." },
  journeyStep2: {
  ...
  notifRefClearedTitle: { he: "עורך הדין זמין לפנייתך", en: "The lawyer is available for your request" },
  notifRefClearedBody: { he: "הוא בדק ניגוד עניינים ואישר זמינות. עכשיו תורך: אשר את שיתוף הסיכום.", en: "They checked for conflicts and confirmed availability. Your turn: approve sharing the summary." },
  ...
  notifRefAutoTitle: { he: "עורך הדין זמין — הסיכום שותף", en: "The lawyer is available — summary shared" },
  notifRefAutoBody: { he: "הוא אישר זמינות, והסיכום שותף אוטומטית לפי אישורך. נעדכן כשתגיע הצעת שכר טרחה.", en: "They confirmed availability, and the summary was shared automatically per your approval. We'll update you when a fee proposal arrives." },
