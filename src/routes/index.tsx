        ...
        <Stagger className="w-full max-w-sm space-y-4 self-center pb-4">
          <Rise>
            <Pressable
              ...
              className="liquid-glass glass-hero group block w-full rounded-[26px] p-5 text-start"
            >
          ...
          <Rise>
            <Pressable
              ...
              className="liquid-glass-selected glass-hero group block w-full rounded-[26px] p-5 text-start"
            >
              <div className="relative flex items-center gap-5">
