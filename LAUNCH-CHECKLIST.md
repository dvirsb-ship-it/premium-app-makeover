...
| `AI_REDACTION_ENABLED` | `src/lib/ai/redact.ts` | **false** | נוגע בצינור שמכריע אם לתיק יש עילה, ואיכות התזכיר מתאמתת רק בתיק אמיתי | אחרי פתיחת תיק בדיקה אחד שנבדק ואושר כרגיל |
...
- [ ] `AI_REDACTION_ENABLED` — לפתוח תיק בדיקה, לוודא שנבדק ואושר כרגיל,
      ורק אז להדליק. **מדיניות הפרטיות תתעדכן רק כשהמתג דלוק** — עד אז
      אסור להבטיח שמזהים אינם נשלחים
